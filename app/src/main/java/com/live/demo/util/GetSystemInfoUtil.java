...
/**
 * Created by TingYu Zhu on 2017/10/24.
 */
...
public class GetSystemInfoUtil {
    ...
    public static Map getImeiAndMeid(Context ctx) {
        ...
        try {
            ...
            meid = mTelephonyManager.getDeviceId();
            map.put("meid", meid);
            if (!TextUtils.isEmpty(gsm)) {
                ...
                map.put("id1", mTelephonyManager.getDeviceId(0));
                map.put("id2", mTelephonyManager.getDeviceId(1));
